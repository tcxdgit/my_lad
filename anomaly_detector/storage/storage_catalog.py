...
class StorageCatalog:
    ...
    @classmethod
    def _std_datasource_api(cls, config):
        """stdin storage datasource construction"""
        logging.info("fetching stdin datasource")
        return StdStorageDataSource(configuration=config)
    ...
    _class_method_choices = {'local.sink': _localfile_datasink_api,
                             ...
                             'std.source': _std_datasource_api}
